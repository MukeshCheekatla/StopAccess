      ...
      <div className="fg-flex fg-min-w-0 fg-flex-1 fg-items-center fg-gap-3">
        ...
        <div className="fg-min-w-0 fg-flex-1">
          ...
          <div className="fg-mt-0.5 fg-flex fg-items-center fg-gap-[6px]">
            ...
            <select
              className="fg-h-6 fg-cursor-pointer fg-appearance-none fg-rounded-[6px] fg-border-0 fg-bg-white/[0.05] fg-px-1.5 fg-text-[10px] fg-font-bold fg-text-white fg-outline-none"
              value={limitValue}
              onChange={(e) =>
            ...
            >
              {limitOptions.map((opt) => (
                <option key={opt.value} value={opt.value} className="fg-bg-zinc-900">
                  {opt.label}
                </option>
              ))}
            </select>
