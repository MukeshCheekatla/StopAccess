      ...
      if (step === 1) {
        ...
        container.innerHTML = `
          <div class="glass-card widget-card" style="padding: 60px 20px; display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 480px;">
            ...
            <div class="glass-card" style="margin-bottom: 32px; width: 100%; text-align: left; cursor: pointer; border: 1px solid rgba(255,255,255,0.2); background: rgba(255, 255, 255, 0.03); padding: 20px;" id="pickLevel2">
