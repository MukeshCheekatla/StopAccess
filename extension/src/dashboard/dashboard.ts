import { renderDashboardPage as renderDashboard } from '../screens/DashboardPage';
import { renderAppsPage as renderAppsScreen } from '../screens/AppsPage';
import { renderFocusPage as renderFocusScreen } from '../screens/FocusPage';
import { renderSchedulePage as renderScheduleScreen } from '../screens/SchedulePage';
import { renderInsightsPage as renderInsightsScreen } from '../screens/InsightsPage';
import { renderSettingsPage as renderSettingsScreen } from '../screens/SettingsPage';
import {
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (!isSet && !isOnboardingDone) {
    const { renderOnboarding } = await import('../screens/OnboardingScreen');
